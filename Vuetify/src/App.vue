...
<template>
  <v-app>
    <v-toolbar density="compact">
      ...
      <v-toolbar-title>
        <RouterLink to="/">My First Vuetify Website</RouterLink> 
      </v-toolbar-title>

      <v-spacer></v-spacer>
      

     <v-btn icon @click="changeTheme"> <!--change theme method call -->
      ...
      <v-menu transition="scale-transition">
        ...
        <v-list>
          <v-list-item
            ...
            :value="index"
          >
            <v-list-item-title><v-icon :color="item.color":icon="item.icon" ></v-icon>{{ item.title }}</v-list-item-title>
          </v-list-item>
        </v-list>
      </v-menu>
